...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    var options = {
      ...
      name: "Smartmart.Com",
      description: "Payment for Purchased",
  ...
  return (
    <Layout>
      <div
        className="h-screen bg-gray-100 pt-14 overflow-x-auto  "
        style={{
          backgroundColor: mode === "dark" ? "#282c34" : "",
          color: mode === "dark" ? "white" : "",
        }}
      >
        <h1 className="mb-1 text-center text-2xl font-bold">Cart Items</h1>
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
          ...
          >
            ...
            <p className='text-black'><strong>NB</strong>: Please clear the cart after <strong>Successfull Payment</strong> to avoid any future confusions</p>
            <Modal
              name={name}
              address={address}
              pincode={pincode}
